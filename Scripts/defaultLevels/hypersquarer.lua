...
function addPattern(mKey)
	...
	if mKey ==  0 then squarealtspiral(53)
	elseif mKey ==  1 then squarerain(33)
	elseif mKey ==  2 then squaresolo(32)
	elseif mKey ==  3 then squareInverseBarrage(2,33)
	elseif mKey ==  4 then squarespiral(35)
	elseif mKey ==  5 then square1spin(38)
	elseif mKey ==  6 then squarestaggeredspiral(31)
	end
end

-- shuffle the keys, and then call them to add all the patterns
-- shuffling is better than randomizing - it guarantees all the patterns will be called
keys = { 0, 0, 0, 1, 1, 1, 2, 2, 2, 2, 2, 2, 2, 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6}
keys = shuffle(keys)
index = 0
